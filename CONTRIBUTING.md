...
Thank you for improving **FitGround**.
...
- repository tests for changed modules
- reproducibility checks for affected evidence artifacts
- no change to measured claims without regenerated reports
